...
func ufmt(u *URL) string {
	...
	return fmt.Sprintf("opaque=%q, scheme=%q, user=%#v, pass=%#v, host=%q, port=%q, path=%q, rawq=%q, frag=%q",
		u.Opaque, u.Scheme, user, pass, u.Host, u.Port, u.Path, u.RawQuery, u.Fragment)
}
